<template>
  <div class="sub-menu" :style="mobileActive && { top: '20px' }">
    <ul class="primary">
      <li class="mainitem">
        <h4
          class="mainbtn"
        ...
        >
          ...
          <h5
            class="title 2"
            @click="location = [false, !location[1], false, false]"
          >
          ...
          <h5
            class="title 3"
            @click="location = [false, false, !location[2], false]"
          >
          ...
          <h5
            class="title 4"
            @click="location = [false, false, false, !location[3]]"
          >
            <b>UMAMI 金色三麥</b
